...
public class MiniAppsConfig {
     public enum MiniApps {
        SdkMobileMiniAppTest("SdkMobileMiniAppTest", SdkMobileMiniAppTestActivity.class),
        ;
    ...
    public static final HashMap<String, Class> MINIAPP_ACTIVITIES = new HashMap<String, Class>() {{
        put(MiniApps.SdkMobileMiniAppTest.getName(), MiniApps.SdkMobileMiniAppTest.getActivityClass());
    }};
}
